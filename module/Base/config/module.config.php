		...
		'bjyauthorize' => array (
				'guards' => array (
						'BjyAuthorize\Guard\Route' => array (
								...
								array (
										'route' => 'zfcuser/forgotpassword',
										'roles' => array (
												'guest' 
										) 
								),
								array (
										'route' => 'zfcuser/resetpassword',
										'roles' => array (
												'guest' 
										) 
								),
								...
								array (
										'route' => 'scn-social-auth-user/authenticate/provider',
										'roles' => array (
												'guest' 
										) 
								),
								array (
										'route' => 'scn-social-auth-user/authenticate',
										'roles' => array (
												'guest' 
										) 
								),
								...
								array (
										'route' => 'zfcadmin/languages/default',
										'roles' => array (
												'admin' 
										) 
								) 
