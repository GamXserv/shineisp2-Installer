...
class UserRegisterListener implements ListenerAggregateInterface {
	...
	public function attach(EventManagerInterface $events) {
		...
		$this->listeners [] = $sharedEvents->attach ( 'ZfcUser\Service\User', 'register.post', array (
				$this,
				'onRegister' 
		), 100 );
		$this->listeners [] = $sharedEvents->attach ( 'ScnSocialAuth\Authentication\Adapter\HybridAuth', 'registerViaProvider.post', array (
				$this,
				'onRegister' 
		), 100 );
	}
